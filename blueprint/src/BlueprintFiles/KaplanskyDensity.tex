...
\begin{lemma}
  ...
  \lean{WeakBilin.tendsto_of_denseRange_of_eventually_norm_le}
  \leanok
...
\begin{definition}
  ...
  \lean{Ultraweak.SakaiInvariantTestSpace}
  \leanok
...
\begin{lemma}
  ...
  \lean{Ultraweak.SakaiInvariantTestSpace.mackeyMulLeftL,Ultraweak.SakaiInvariantTestSpace.mackeyMulRightL,Ultraweak.SakaiInvariantTestSpace.mackeyStarL}
  \leanok
...
\begin{definition}
  ...
  \lean{CStarAlgebra.kaplanskyTransform}
  \leanok
...
\begin{proposition}
  ...
  \lean{CStarAlgebra.isUnit_one_add_star_mul_self,CStarAlgebra.kaplanskyTransform_mem_closedBall}
  \leanok
...
\begin{lemma}
  ...
  \lean{CStarAlgebra.kaplanskyTransform_mem_nonUnitalStarSubalgebra}
  \leanok
...
\begin{lemma}
  ...
  \lean{CStarAlgebra.kaplanskyTransform_eq_self_of_mem_extremePoints_unitClosedBall}
  \leanok
...
\begin{proposition}
  ...
  \lean{Ultraweak.SakaiInvariantTestSpace.kaplanskyTransform_mem_ultraweak_closure}
  \leanok
...
\begin{theorem}
  ...
  \lean{Ultraweak.SakaiInvariantTestSpace.kaplansky_density_Sak_1_9_1}
  \leanok
...
\begin{corollary}
  ...
  \lean{Ultraweak.SakaiInvariantTestSpace.kaplansky_density_ultraweak}
  \leanok
