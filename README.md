...
Kaplansky density theorem, and the Section 1.10 development through central-support orthogonality.
Section 1.11 on spectral resolution is the next mathematical frontier.
