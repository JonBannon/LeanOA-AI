...
The remaining source work is therefore theorem assembly rather than a missing topology carrier.
Sak-AI now takes
...
predual. Until the final source theorem assembly exists, Sakai
...
two one-way continuous identities. The next gap is the final global closedness assembly.
