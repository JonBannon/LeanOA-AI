...
support recovery for `x = CStarAlgebra.spectralPositivePart a r` from source-faithful ultraweak
approximation data for a competing monotone projection family `e`.
